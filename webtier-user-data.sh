...
CHEF_SERVER_NAME="my-chef-automation" # The name of your Chef Server
CHEF_SERVER_ENDPOINT="my-chef-automation-5srxmup4n5rmomsg.us-west-2.opsworks-cm.io" # The FQDN of your Chef Server
...
RUN_LIST="recipe[chef-client],recipe[manageservice]" # optional, only when not using Policy
